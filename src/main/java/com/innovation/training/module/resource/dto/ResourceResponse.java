...
public class ResourceResponse {
    ...
    public static ResourceResponse from(TeachingResource resource) {
        ResourceResponse response = new ResourceResponse();
        response.setId(resource.getId());
        response.setUserId(resource.getUserId());
        ...
        response.setGrade(resource.getGrade());
        response.setCounty(resource.getCounty());
        response.setSchool(resource.getSchool());
        ...
        response.setFavoriteCount(resource.getFavoriteCount());
        response.setSourceType(resource.getSourceType());
        response.setSourceId(resource.getSourceId());
        response.setAuditStatus(resource.getAuditStatus());
